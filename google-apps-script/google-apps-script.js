/**
 * Google Apps Script for "25th Jharkhand State Pedicon & 29th Annual Conference IAP Jamshedpur"
 * 
 * Instructions:
...
// Configuration
const ORGANIZER_EMAIL = "akashbca9508@gmail.com"; 
const CONFERENCE_NAME = "25th Jharkhand State Pedicon & 29th Annual Conference IAP Jamshedpur";
const VENUE = "Hotel Ramada, Jamshedpur";
const DATES = "12th & 13th December 2026";
...
function onFormSubmit(e) {
  try {
    ...
    MailApp.sendEmail({
      to: ORGANIZER_EMAIL,
      subject: `New Pedicon Registration: ${fullName} (${city})`,
      htmlBody: adminHtml,
      name: "Pedicon Web Portal Notification"
    });
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="intro-text">
              We are delighted to confirm your registration for the upcoming <strong>25th Jharkhand State Pedicon & 29th Annual Conference of IAP Jamshedpur</strong>. Your details have been successfully logged in our delegates database.
            </div>
            
            <div class="info-block">
              <strong>Event Dates:</strong> ${DATES}<br>
              <strong>Pre-Conference Workshops:</strong> 11th December 2026<br>
            ...
            <p style="font-size: 12px; color: #9ca3af; text-align: center; margin-top: 30px;">
              For any booking or presentation inquiries, contact us at <a href="mailto:${ORGANIZER_EMAIL}">${ORGANIZER_EMAIL}</a> or call +91 7649390574.
            </p>
          </div>

          <div class="footer">
            <p><strong>Indian Academy of Pediatrics (IAP) Jamshedpur Branch</strong></p>
            <p>Hotel Ramada Convention Hub, Bistupur, Jamshedpur, Jharkhand</p>
  ...
  <html>
    <body>
      <div style="font-family: Arial, sans-serif; color: #333333; max-width: 600px; margin: 0 auto; border: 1px solid #dddddd; padding: 20px; border-radius: 8px;">
        ...
        <p>A new delegate has registered online for <strong>Pedicon Jamshedpur 2026</strong>. Details are listed below:</p>
